            ...
            <div id="content">
                ...
                <div class="container-fluid">
                   ...
                   <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Give Task & Feedback:</h1>
                    </div>  
                         ...
                         while($row = mysqli_fetch_array($result))
                         {
                          ...
                          $output .= '
                           <tr>
                            ...
                            <td>'.$row["email"].'</td>
                            <td>
                            <button type="button" class="btn btn-success"><a href="add_task.php?id=' . $sid=$row['student_id'] . '" style="color: white;">Task</a></button>
                            
                            <button type="button" class="btn btn-success"><a href="add_feed.php?id=' . $sid=$row['student_id'] . '" style="color: white;">Feedback</a></button>
