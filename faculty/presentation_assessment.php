    ...
    $sql = " SELECT faculty_name  FROM `faculty` where faculty_email = '" . $_SESSION['fac_email'] . "' ";
       ...
       @ $_SESSION['a_id']=$_GET['id'];
        if(isset($_POST['submit'])){
            ...
            $_SESSION['pscore']=$checked_count;
            $p_score=$_SESSION['pscore'];
            $sid=$_SESSION['a_id'];


            $add = " INSERT INTO presentation_skill VALUES ('','$sid',NOW(),'$p_score') ";
            $result = mysqli_query($conn,$add);
                if(!$result){
                    ...
                    echo 'window.location.href = "../faculty/presentation_assessment.php";';
                    echo '</script>';
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h6>Assessment Category:<strong> Presentation Skill Test</strong></h6>
                            <br>
                                    <!-- display student id: -->
		                       ...
		                       <br>   
                                    ...
                                    <!-- display presentation checklist -->
                                    ...
                                    <?php 
                                        ...
                                        $sql = " SELECT * FROM questions_presentation";
                                        ...
                                        if($result){
                                            ...
                                            while($row = mysqli_fetch_array($result)){
                                                ...
                                                echo "<tr>";
                                                echo "<td>";
                                                echo "<td>".$row['q_presentation_id']."<td>".$row['p_question']."</td>"; 
                                                echo "<td>";
                                            ...
                                            // echo "<button type='submit' class='btn btn-success float-right ' id='submit' value='submit'  name='submit' >Submit</button><br><br>";
