        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form class="form-horizontal" role="form" method="post" action="task.php">
                    ...
                    <label class="col-md-3 control-label" for="title">Student ID: </label>
								...
								<label class="col-md-3 control-label" for="title">Task Title: </label>
								 <div class="col-md-8">
				                  <input class="form-control" type="text" id="title" name="title" required>
				               	 </div><br>
	          				 
					            <label class="col-lg-3 control-label"> Task Description:</label>
					            <div class="col-lg-8">
					              <textarea class="form-control" onkeyup="textCounter(this,'counter',250);" type="text" id="task_description" name="task_description" rows="5" required></textarea><br>
								...
								<label class="col-md-3 control-label" for="due">Task Duedate: </label>
								 <div class="col-md-8">
				                  <input class="form-control" type="datetime-local" id="due" name="due" required>
				               	 </div>
	          				  </div>
                    ...
                    <script>
		    function goBack() {
			window.location.href = '../faculty/add_task.php';
		}
	</script>
                <!-- /.container-fluid -->
