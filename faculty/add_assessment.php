            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Add Assessment:</h1>
                    </div>  
                        <div class="panel panel-primary filterable">
                <div class="pull-right">
                <!-- <h6>The Following Displays the list of Students assigned to you:</h6> -->
                    <button class="btn btn-primary btn-sm btn-filter"><span class="glyphicon glyphicon-filter"></span> Filter Search</button>
                </div>
                ...
                <thead>
                    <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="Mob No" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Email" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Assessment" disabled></th>
                ...
                <tbody>
                    <?php
                        ...
                        {
                            //used inner join to display assigned students
                          $query= " SELECT s.student_id,s.first_name,s.last_name,s.department, s.mob_no,s.email FROM student AS s INNER JOIN assign_student AS a ON s.student_id=a.stud_id WHERE a.f_name='$fac_name'";
                        }
                           ...
                           <tr>
                            ...
                            <div class="dropdown mb-4">
                                        ...
                                        <div class="dropdown-menu animated--fade-in"
                                            ...
                                            <a class="dropdown-item" href="../faculty/presentation_assessment.php?id=' . $id=$row["student_id"] . '" ">Presentation Skill</a>
                                            <a class="dropdown-item" href="../faculty/communication_assessment.php?id=' . $id=$row["student_id"] . '" ">Communication Skill</a>
                                            <a class="dropdown-item" href="../faculty/written_assessment.php?id=' . $id=$row["student_id"] . '" ">Writing Skill</a>
                                        </div>
                                    </div>
                          </td>
                           </tr>
