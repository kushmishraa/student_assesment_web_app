<?php
    ...
    $sql = " SELECT faculty_name  FROM `faculty` where faculty_email = '" . $_SESSION['fac_email'] . "' ";
        ...
        if(isset($_POST['submit'])){
            ...
            $_SESSION['wscore']=$checked_count;
            $w_score=$_SESSION['wscore'];
            $sid=$_SESSION['a_id'];


            $add = " INSERT INTO written_skill VALUES ('','$sid',NOW(),'$w_score') ";
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h6>Assessment Category:<strong> Written Skill Test</strong></h6>
                            <br>
		                       ...
		                       <br>   
                                    ...
                                    <?php 
                                        ...
                                        $sql = " SELECT * FROM questions_writing";
                                        ...
                                        if($result){
                                            ...
                                            while($row = mysqli_fetch_array($result)){
                                                echo "<tr>";
                                                echo "<td>";
                                                echo "<td>".$row['q_written_id']."<td>".$row['w_question']."</td>"; 
                                                echo "<td>";
                                                echo " <div class='form-check '>
                                                            <input class='form-check-input check1' type='checkbox' name='check[]' value='' id='defaultCheck1'>
