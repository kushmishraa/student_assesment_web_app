            ...
            <div id="content">
                ...
                <div class="container-fluid">
                     ...
                     <div class="card shadow mb-4">
				        ...
				        <form class="form-horizontal" role="form" method="post" action="addstudent.php">
                          ...
                          <div class="form-group">
				            ...
				            <div class="col-lg-8">
				              <input class="form-control" type="text" maxlength=10 name="num" required>
				            </div>
				          </div>
				          <div class="form-group">
                    ...
                    <!-- ***************************************** -->
                                ...
                                <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">+ New Faculty</h6>
                                </a>
                                <!-- Card Content - Collapse -->
                                <div class="collapse show" id="collapseCardExample">
                                    <div class="card-body">
                                   
				        <form class="form-horizontal" role="form" method="post" action="addfaculty.php">
				          <div class="form-group">
				            <label class="col-lg-3 control-label">Faculty  Name:</label>
				            <div class="col-lg-8">
				              <input class="form-control" type="text" name="facultyname" required>
				            </div>
				          </div>
				          ...
				          <div class="form-group">
				            <label class="col-md-3 control-label"></label>
				            <div class="col-md-8">
				              <input type="submit" name="submit" class="btn btn-primary" value="Add Faculty">
				              <span></span>
				              <input type="reset" class="btn btn-default" value="Cancel" onclick="goBack()">
				            </div>
				          </div>
