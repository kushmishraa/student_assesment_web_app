            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Delete Faculty Record</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
				        ...
				        <form class="form-horizontal" role="form" method="post" action="removefaculty.php">
				          <div class="form-group">
				            <label class="col-lg-3 control-label">Faculty  Name:</label>
				            <div class="col-lg-8">
                            <input type="text" value="<?php $sql = "SELECT faculty_name FROM faculty WHERE faculty_id = '$id' ";
                                  ...
                                  ?>" class="form-control" name="facultyname" readonly>
				            </div>
				          </div>
                          ...
                          <div class="form-group">
				            ...
				            <div class="col-md-8">
                              ...
                              value="<?php $sql = "SELECT faculty_password FROM faculty WHERE faculty_id = '$id' ";
                                        $result = mysqli_query($conn,$sql);
                                        if($result){
                          ...
                          <div class="form-group">
				            ...
				            <div class="col-lg-8">
                            <input type="text" value="<?php $sql = "SELECT faculty_mob_no FROM faculty WHERE faculty_id = '$id' ";
                                        $result = mysqli_query($conn,$sql);
                                        if($result){

                                        while($row = mysqli_fetch_array($result)){

                                                echo $row['faculty_mob_no'];
				          ...
				          <div class="form-group">
				            ...
				            <div class="col-lg-8">
                            <input type="text" value="<?php $sql = "SELECT faculty_email  FROM faculty WHERE faculty_id = '$id' ";
                                        $result = mysqli_query($conn,$sql);
                                        if($result){
