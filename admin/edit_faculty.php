            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Faculty Information</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
				        ...
				        <form class="form-horizontal" role="form" method="post" action="editfaculty.php">
                        <div class="form-group">
				            <label class="col-lg-3 control-label">Faculty  id:</label>
				            <div class="col-lg-8">
                            <input type="text" value="<?php $sql = "SELECT faculty_id  FROM faculty WHERE faculty_id = '$id' ";
				          ...
				          <div class="form-group">
				            ...
				            <div class="col-lg-8">
                              ...
                              value="<?php $sql = "SELECT faculty_name  FROM faculty WHERE faculty_id = '$id' ";
                                        $result = mysqli_query($conn,$sql);
                                        if($result){
                          ...
                          <div class="form-group">
				            ...
				            <div class="col-lg-8">
                              ...
                              value="<?php $sql = "SELECT faculty_mob_no  FROM faculty WHERE faculty_id = '$id' ";
                                        $result = mysqli_query($conn,$sql);
                                        if($result){
				          ...
				          <div class="form-group">
				            ...
				            <div class="col-lg-8">
                              ...
                              value="<?php $sql = "SELECT faculty_email  FROM faculty WHERE faculty_id = '$id' ";
                                        $result = mysqli_query($conn,$sql);
                                        if($result){
